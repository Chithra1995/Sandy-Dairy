  ...
  return (
    <div className="home">
      <div className="home-banner">
        <img src="images/A2-milk.jpg" width="100%" alt="" title=""></img>
      </div>
      <div className="home-favourite pt_40">
        <div className="row m-0">
          ...
          <div className="col-lg-6">
            <img
              src="images/poorvika-icecream.png"
              width="100%"
              alt=""
              title=""
            ></img>
          ...
          <div className="col-lg-6">
            <img
              src="images/poorvika-mik-shake.png"
              width="100%"
              alt=""
              title=""
            ></img>
        ...
        <div className="row m-0">
          {data.home_product.map((home) => (
            <div className="col-lg-3 mb-4 our-product-cnt">
              <img src={home.image} width="100%" alt="" title=""></img>
      ...
      <div className="home-delivery-banner pt_40">
        <img
          src="images/home-delivery-banner.png"
          width="100%"
          alt=""
          title=""
        ></img>
      ...
      <div className="home-app-screen pt_40 pb_40">
        <div className="row m-0 align-items-center">
          <div className="col-lg-4">
            <img src="images/app-screen.png" width="100%" alt="" title=""></img>
          </div>
          <div className="col-lg-4">
            <h1>
              GET <br />
          ...
          <div className="col-lg-3 offset-lg-1">
            <div className="app_cnt">
              ...
              <img
                ...
                title=""
              ></img>
              <img src="images/app-store.png" alt="" title=""></img>
            </div>
            <div className="app_cnt mt_40">
              ...
              <ul className="d-flex mt-5">
                ...
                <li>
                  <img
                    src="images/daily-ninja-icon.png"
                    width="100%"
                    alt=""
                    title=""
                  ></img>
